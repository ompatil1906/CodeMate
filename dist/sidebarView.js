...
exports.CodeMateSidebarProvider = void 0;
const vscode = require("vscode");
class CodeMateSidebarProvider {
    constructor(context) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            switch (message.type) {
                case "query":
                    ...
                    (_a = this._view) === null || _a === void 0 ? void 0 : _a.webview.postMessage({ type: "response", text: formattedResponse });
                    break;
            }
        });
    }
...
exports.CodeMateSidebarProvider = CodeMateSidebarProvider;
CodeMateSidebarProvider.viewType = "codemateView";
